...
CREATE USER 'db_owner'@'172.19.0.4' IDENTIFIED BY 'ownersj2';
CREATE USER 'db_admin'@'172.19.0.4' IDENTIFIED BY 'adminsj2';
CREATE USER 'db_user'@'172.19.0.4' IDENTIFIED BY 'usersj2';
USE `INT371`;
GRANT SELECT, INSERT, UPDATE, DELETE ON INT371.* TO 'db_owner'@'172.19.0.4';
GRANT SELECT, INSERT, UPDATE, DELETE ON INT371.* TO 'db_admin'@'172.19.0.4';
GRANT SELECT ON INT371.* TO 'db_user'@'172.19.0.4';
USE `INT371_02`;
GRANT SELECT, INSERT, UPDATE, DELETE ON INT371_02.* TO 'db_owner'@'172.19.0.4';
GRANT SELECT ON INT371_02.* TO 'db_admin'@'172.19.0.4';
GRANT SELECT ON INT371_02.* TO 'db_user'@'172.19.0.4';
